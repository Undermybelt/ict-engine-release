...
Auditable source:  support/scripts/ibkr_bridge/bridge.py,
                   support/scripts/ibkr_bridge/consumer.py,
                   support/scripts/ibkr_bridge/rate_limiter.py
Capabilities file: ~/.ict-engine/ibkr_capabilities.json (gitignored, local)
Revoke any time:   python support/scripts/ibkr_bridge/setup.py --revoke
...
源代码可审：    support/scripts/ibkr_bridge/bridge.py,
                support/scripts/ibkr_bridge/consumer.py,
                support/scripts/ibkr_bridge/rate_limiter.py
能力文件：      ~/.ict-engine/ibkr_capabilities.json (gitignored, 本地)
随时撤回同意：  python support/scripts/ibkr_bridge/setup.py --revoke
"""
...
def require_ibkr_enabled(path: Path = CONSENT_PATH,
    ...
    if not interactive:
        sys.exit(
            ...
            "    support/scripts/ibkr_bridge/README.md"
            "\n"
        )
