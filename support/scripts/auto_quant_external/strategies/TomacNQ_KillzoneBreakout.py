...
Provenance: idea originally seeded by <tomac-source-root>/ultimate_ict_strategy.py and 90wr1.5rrr_strategy.py (read-only). Source data: <tomac-source-root>/nq future 2021-2025/NQ_1min_Continuous_Shifted_2836.csv resampled by prepare_external.py.
"""
