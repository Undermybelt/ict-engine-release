...
TARGET = REPO / 'support' / 'scripts' / 'archive' / 'pre_bayes_policy_tuning.py'

BACKEND_HELP = """Archived Pre-Bayes policy tuning backend. It evaluates evidence/gate/shrink/bridge bottleneck configs.

Backend: support/scripts/archive/pre_bayes_policy_tuning.py
...
Examples:
  ...
  python3 support/scripts/evaluate_bottleneck.py --target
  python3 support/scripts/evaluate_bottleneck.py --backend-help
  python3 support/scripts/evaluate_bottleneck.py --show-config
  python3 support/scripts/evaluate_bottleneck.py --run --data-root /path/to/ict-cleaned-mtf
