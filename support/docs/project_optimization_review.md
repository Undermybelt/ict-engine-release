...
建议新增：
1. `support/docs/research-system-map.md`
2. `support/docs/objective-scoring-map.md`
3. `support/docs/experiment-integrity-rules.md`
4. `support/docs/feature-intake-rules.md`
