...
- `support/scripts/evidence_quality_breakdown.py`
...
- use isolated state
- run `python3 support/scripts/search_local.py --show-config`
- then run `python3 support/scripts/search_local.py --run --data-root <ict-cleaned-mtf>`
- read `results.json`
- optionally summarize with `python3 support/scripts/research_verdict.py <state-or-result-dir>`
...
- if still unclear, run:
  ...
  - `python3 support/scripts/evidence_quality_breakdown.py ...`
