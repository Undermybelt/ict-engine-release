...
- files read:
  - `README.md`
  - `ADAPTERS.md`
  - `support/docs/concepts/events.md`
  - `support/docs/getting_started/backtest_low_level.py`
...
This is already partially visible in `support/docs/architecture-boundaries.md`; NautilusTrader is a strong external example of doing this consistently.
