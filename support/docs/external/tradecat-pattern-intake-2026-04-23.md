...
- files read:
  ...
  - `README.md`
  - `README_EN.md`
  - `support/scripts/smoke_query_service.sh`
...
`support/scripts/smoke_query_service.sh` is a valuable pattern because it tests:
...
The closest translation would be smoke-style support/docs/scripts for:
