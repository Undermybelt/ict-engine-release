...
This document is intentionally narrower than `support/docs/research-system-map.md`. It only covers the autoresearch session files and the new human-readable derived outputs.
