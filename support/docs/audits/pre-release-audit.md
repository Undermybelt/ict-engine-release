...
2. help quality
   ...
   - audit artifacts exist in:
     ...
     - `support/docs/audits/help-audit.json`
     - `support/docs/audits/help-audit.md`
...
For current remaining debt, use `support/docs/plans/2026-04-24-post-main-debt-inventory.md`.
