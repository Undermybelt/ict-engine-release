...
Purpose
- audit the full `support/docs/` tree for features or constraints that docs imply should exist
...
Scope
- audited `109` files under `support/docs/`
...
2. targeted review of:
   ...
   - `support/docs/plans/2026-04-24-post-main-debt-inventory.md`
   - `support/docs/research-system-map.md`
   - `support/docs/2026-04-24-open-source-shakedown-handoff.md`
...
#### 1. `support/docs/release-notes-draft.md` still contains stale wrapper/run guidance
...
Current mismatches
- it still lists `python3 support/scripts/search_local.py --run` as the “new habit” instead of the guarded flow
...
Evidence
- `support/docs/release-notes-draft.md:67`
- `support/docs/release-notes-draft.md:79`
...
#### 2. `support/docs/research-system-map.md` still contains one stale direct-run workflow
...
- but the later bottleneck workflow still includes:
  - `python3 support/scripts/evaluate_bottleneck.py --run`
  - without the new `--show-config` / `--data-root` gate

Evidence
- `support/docs/research-system-map.md:230`
...
#### 3. `support/docs/main-rs-extraction-closeout-2026-04-23.md` still contains the old “substantially closed” body text
...
Evidence
- `support/docs/main-rs-extraction-closeout-2026-04-23.md:10`
- `support/docs/main-rs-extraction-closeout-2026-04-23.md:58`

Action
- no urgent change required

#### 4. `support/docs/plans/2026-04-24-one-shot-structural-debt-closure-plan.md` still describes the old pre-landing debt picture
...
Evidence
- `support/docs/plans/2026-04-24-one-shot-structural-debt-closure-plan.md:12`
...
Evidence
- `support/docs/external/autoresearch-pattern-intake-2026-04-23.md:116`
...
- updates `support/docs/release-notes-draft.md` to the guarded wrapper flow
- updates the remaining wrapper examples in `support/docs/research-system-map.md`
