...
| 2 | Agent-friendly | Met | `--agent` and `--compact` output modes, `workflow-status` emits `next_step` / `next_command`, `support/docs/agent-first-runbook.md` defines agent intent routing |
...
| 4 | Guidance-friendly | Met | `README.md` + `support/docs/first-run.md` + `support/docs/agent-first-runbook.md`; `src/application/reporting/human_report.rs::humanize_next_step_line` prevents raw `ask-user:` syntax from leaking into human output |
| 5 | Data source | Met | `analyze-live` over openbb / openalice / nofx backends; `clean-futures` for TOMAC CSV ingest; `support/examples/demo/demo-15m.json` bundled demo; `src/application/data_sources/` submodule |
...
- `support/docs/agent-first-runbook.md` defines six common agent intents and maps them onto CLI routes.
...
- `README.md`, `support/docs/first-run.md`, `support/docs/agent-first-runbook.md`, `support/docs/smoke-acceptance.md`, `support/docs/release-mirror-runbook.md` form a complete onboarding chain for contributors, agents, operators, and release owners.
...
- `support/examples/demo/demo-15m.json` is a bundled demo candle bundle so every smoke run works without external data.
...
1. Keep reducing `src/main.rs` by continuing the extraction plan in `support/docs/plans/main-rs-extraction-plan.md`.
...
- Doc cross-check against `README.md`, `support/docs/agent-first-runbook.md`, `support/docs/first-run.md`, `support/docs/smoke-acceptance.md`, `support/docs/release-mirror-runbook.md`, `support/docs/autoresearch-derived-surfaces-contract.md`, `support/docs/autoresearch-state-transitions.md`.
