...
> Relationship to prior audit: complements [support/docs/audits/2026-04-21-cross-surface-review.md](./2026-04-21-cross-surface-review.md) with fresh whole-repo command simulations, contributor-first-run checks, and agent/user shakedown coverage
...
11. `cargo run -- factor-pipeline-debug --symbol DEMO --data support/examples/demo/demo-15m.json --factor structure_ict --objective expansion_manipulation`
...
18. `cargo run -- factor-backtest --symbol DEMO --data support/examples/demo/demo-15m.json --human`
19. `cargo run -- backtest --symbol DEMO --data support/examples/demo/demo-15m.json --human`
...
- contributor trust is damaged because support/docs/audits imply cleaner lint status than reality
...
- `cargo run -- factor-backtest --symbol DEMO --data support/examples/demo/demo-15m.json --human`
...
- `cargo run -- backtest --symbol DEMO --data support/examples/demo/demo-15m.json --human`
