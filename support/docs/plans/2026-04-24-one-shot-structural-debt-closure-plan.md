...
**Tech Stack:** Rust, Cargo, existing `src/application/*` module layout, bin-side shell modules in `src/*.rs`, markdown docs under `support/docs/`.
...
- use `support/docs/plans/2026-04-24-post-main-debt-inventory.md` for post-`main.rs` debt status

---

## Scope Summary

This plan replaces the now-stale claim in `support/docs/main-rs-extraction-closeout-2026-04-23.md` that the extraction debt is "substantially closed."
...
6. The debt narrative in docs is internally inconsistent:
   - `support/docs/main-rs-extraction-closeout-2026-04-23.md` says the extraction line is substantially closed
...
1. Archived backend portability debt documented in `support/docs/backend-path-audit.md`
...
- Modify: `support/docs/main-rs-extraction-closeout-2026-04-23.md`
...
**Files:**
- Create: `support/docs/plans/2026-04-24-one-shot-structural-debt-closure-plan.md`
- Modify: `support/docs/main-rs-extraction-closeout-2026-04-23.md`
- Modify: `support/docs/plans/main-rs-extraction-plan.md`
...
Add a short status note at the top of `support/docs/main-rs-extraction-closeout-2026-04-23.md` pointing to this plan and stating that the prior "substantially closed" conclusion is stale as of `2026-04-24`.

- [ ] **Step 3: Update the old extraction plan header**

Add a note to `support/docs/plans/main-rs-extraction-plan.md` that the plan is now partially superseded by this newer one-shot closure plan and should no longer be treated as current state reporting.

- [ ] **Step 4: Commit**

```bash
git add support/docs/plans/2026-04-24-one-shot-structural-debt-closure-plan.md \
        support/docs/main-rs-extraction-closeout-2026-04-23.md \
        support/docs/plans/main-rs-extraction-plan.md
...
**Files:**
- Modify: `support/docs/main-rs-extraction-closeout-2026-04-23.md`
- Optionally create: `support/docs/main-rs-extraction-closeout-2026-04-24.md`
...
```bash
git add support/docs/main-rs-extraction-closeout-2026-04-23.md support/docs/plans/2026-04-24-one-shot-structural-debt-closure-plan.md src
