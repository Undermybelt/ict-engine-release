...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_distributional_agreement_report.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_distributional_agreement_report'`.
- [x] Implemented: `support/scripts/research/regime_distributional_agreement_report.py`.
...
- [x] Target tests:
  - `python3 -m unittest support/scripts/research/tests/test_regime_distributional_agreement_report.py -v` -> 3 OK.
- [x] Full research suite after R7:
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 75 OK.
...
```bash
python3 support/scripts/research/regime_distributional_agreement_report.py \
...
- [x] `support/scripts/research/regime_transition_governor.py`
- [x] `support/scripts/research/tests/test_regime_transition_governor.py`
...
git add \
  ...
  support/scripts/research/tests/test_regime_distributional_agreement_report.py
```
