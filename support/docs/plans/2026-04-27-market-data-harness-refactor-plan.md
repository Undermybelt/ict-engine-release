...
**Tech Stack:** Rust, serde/serde_json, existing `fetch_external.py`, existing `support/scripts/ibkr_bridge`, direct HTTP for TradingView MCP, existing Yahoo fetch code, Clap.
...
**Files:**
- Modify: `support/docs/2026-04-27-pda-factor-universe-plan.md`
