...
**Baseline / Authority Refs:** `src/application/orchestration/execution_tree.rs`, `src/application/execution/inputs.rs`, `src/application/execution/artifact.rs`, `src/application/reflection/execution_tree_bundle.rs`, `src/factor_research_command.rs`, `support/docs/execution-paper-notes-and-plan-update.md`, `support/docs/plans/factor-autoresearch-minimal-loop.md`, `support/docs/plans/2026-05-03-repo-action-board.md`.
...
- The reverse chain is not `execution tree -> factor` directly. The actual chain is:
  ...
  - CatBoost policy surfaces and prediction vote score
...
### Layer 2: CatBoost Policy Vote Layer
...
- result:
  ...
  - repo-owned additive external tooling exists for wider market routing:
    - `support/scripts/auto_quant_external/config.tomac.json` targets `NQ/USD`
...
- native smoke:
  - `./target/debug/ict-engine factor-research --symbol DEMO --data support/examples/demo/demo-15m.json --backend native --auxiliary-evidence /tmp/ict-engine-family-g-aux-direct.json --state-dir /tmp/ict-engine-family-g-native --output-format json`
  - output contained:
...
- attempted to obtain a first real Family G options/dealer-positioning slice through existing public tooling:
  ...
  - `python support/scripts/auto_quant_external/fetch_external.py binance-kline ...`
  - `python support/scripts/auto_quant_external/fetch_external.py binance-options ...`
  - `python support/scripts/auto_quant_external/fetch_external.py bybit-kline ...`
  - `python support/scripts/auto_quant_external/fetch_external.py bybit-options ...`
...
**Execution**
- authored an external NQ regime strategy pack under `support/scripts/auto_quant_external/strategies/` and mirrored it into the repo as additive helper code, not runtime code.
- created `support/scripts/auto_quant_external/regime_factor_benchmark.py` to score non-trading regime factors without requiring entries/exits.
...
**Execution**
- extended `support/scripts/auto_quant_external/regime_factor_benchmark.py` with:
...
**Execution**
- added an external-only `hmm_viterbi` truth mode to `support/scripts/auto_quant_external/regime_factor_benchmark.py`.
...
**Execution**
- added an external-only `change_point` truth mode to `support/scripts/auto_quant_external/regime_factor_benchmark.py`.
...
**Execution**
- added an external-only `walk_forward_hmm` truth mode to `support/scripts/auto_quant_external/regime_factor_benchmark.py`.
- kept `ict-engine` runtime source frozen.
...
**Execution**
- added two external-only Stage 2 truth modes to `support/scripts/auto_quant_external/regime_factor_benchmark.py`:
...
- authored two new external Auto-Quant strategy files under `support/scripts/auto_quant_external/strategies/` without touching `ict-engine` runtime:
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeLiquiditySweepReclaim.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVRPCarry.py`
...
- kept `ict-engine` runtime source frozen.
- did not modify the in-flight `support/scripts/auto_quant_external/regime_factor_benchmark.py`; `vol_regime_v2` remains a documented design proposal awaiting consolidation with the user's accumulated benchmark edits.

**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeFVGRetrace.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeKillzoneIVProxy.py`
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeCrowdingExhaustion.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeFVGRetrace5m.py`
...
- the `vol_regime_v2` feature design recorded in Slice 72 can now be implemented with real inputs rather than only ATR-derived proxies. The next loop iteration should either:
  ...
  - or write a self-contained `vol_regime_v2_features.py` module under `support/scripts/auto_quant_external/` that defines the new feature columns and an alias `FEATURE_SET_ALIASES["vol_regime_v2"] = VOL_REGIME_V2_VECTOR_FEATURES`, leaving wiring to the user
...
**Outputs**
- `support/scripts/auto_quant_external/vol_regime_v2_features.py`
...
- `support/scripts/auto_quant_external/vol_regime_v2_features.py` (registry update)
...
**Execution**
- authored `support/scripts/auto_quant_external/vol_regime_cross_asset_features.py` as a sibling module to `vol_regime_v2_features.py`. The two modules are deliberately split so callers can wire them independently:
...
**Outputs**
- `support/scripts/auto_quant_external/vol_regime_cross_asset_features.py`
- `support/scripts/auto_quant_external/vol_regime_v2_features.py` (registry alias addition)
...
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeLiquiditySweepReclaimHyper.py`
...
**Execution**
- closed the `FVGRetrace5m` config-vs-class-attribute conflict from Slice 82 by authoring an additive single-strategy wrapper at `support/scripts/auto_quant_external/run_tomac_one.py`. The wrapper imports `run_tomac` from `/Users/thrill3r/Auto-Quant/`, reuses its `_build_exchange_with_synthetic_pairs` synthetic-market injection, and accepts an optional `timeframe` argument that lands in the freqtrade args dict before the strategy is loaded. `config.tomac.json` and `run_tomac.py` stay unchanged.
...
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeTrendPullbackDense15m.py`
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeLiquiditySweepReclaim15m.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeKillzoneIVProxy15m.py`
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimePersistenceClusterDense15m.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeLiquiditySweepReclaim15mWide.py`
...
- authored `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py`. The script:
...
- `support/scripts/auto_quant_external/run_tomac_one.py` (extended with optional EXPORT_PATH arg)
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeSweepLowVIX15m.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeSweepHighVIX15m.py`
- `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py` (CANDIDATES list extended)
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVIXShockReversal15m.py`
- `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py` (extended CANDIDATES + min-trades guardrail)
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVIXShockReversalWide15m.py`
- `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py` (CANDIDATES list extended)
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVVIXDivergence15m.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVIXBackwardation15m.py`
- `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py` (CANDIDATES list extended to 9)
...
**Outputs**
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVIXBackwardationWide15m.py`
- `support/scripts/auto_quant_external/strategies/TomacNQ_RegimeVRPCompression15m.py`
- `support/scripts/auto_quant_external/portfolio_diversity_scorecard.py` (CANDIDATES list extended to 11)
...
**Outputs**
- `support/scripts/auto_quant_external/run_tomac_one.py` (PAIRS override added)
...
**Outputs**
- `support/scripts/auto_quant_external/run_tomac_one.py` (TIMERANGE override added)
...
- authored `support/scripts/auto_quant_external/regime_attribution.py`:
...
**Outputs**
- `support/scripts/auto_quant_external/regime_attribution.py`
...
- authored `support/scripts/auto_quant_external/regime_conditional_basket.py` that:
...
**Outputs**
- `support/scripts/auto_quant_external/regime_conditional_basket.py`
...
- authored `support/scripts/auto_quant_external/regime_conditional_basket_v2.py` that loads NQ daily regimes + VIX9D/VIX3M term structure, applies per-candidate deny rules:
...
**Outputs**
- `support/scripts/auto_quant_external/regime_conditional_basket_v2.py`
...
- authored `support/scripts/auto_quant_external/regime_conditional_basket_v3_oos.py`:
...
**Outputs**
- `support/scripts/auto_quant_external/regime_conditional_basket_v3_oos.py`
...
**Outputs**
- `support/scripts/auto_quant_external/entry_drought_diagnostic.py`
...
- [x] Preserved the reverse chain: execution tree -> execution features -> CatBoost vote -> BBN evidence -> HMM / regime filter -> Auto-Quant factors.
...
- [ ] This board does not claim end-to-end runtime closure by itself; if a slice needs `Auto-Quant -> BBN prior/posterior -> structural path ranking -> execution tree` adoption evidence, hand it to `support/docs/plans/2026-05-07-auto-quant-post-factor-runtime-closure-todo.md`.
