...
Turn the external structural belief literature shortlist into versioned repo artifacts under `support/docs/` so the belief-learning upgrade has local citations, mechanism notes, repo mapping, and code-entry candidates.

## Deliverables

1. `support/docs/structural-belief-learning-literature.md`
...
2. `support/docs/structural-belief-learning-repo-map.md`
...
3. `support/docs/paper-code/structural_belief_learning/README.md`
...
4. `support/docs/paper-code/<slug>/README.md` for 1-2 strongest code candidates
- paper summary
...
3. Build `support/docs/paper-code/structural_belief_learning/` index.
...
- Existing `support/docs/paper-code/*` layout suggests README-first per paper; follow that pattern.
