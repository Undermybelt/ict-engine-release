...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_sidecar_pipeline.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_sidecar_pipeline'`.
- [x] Implemented: `support/scripts/research/regime_sidecar_pipeline.py`.
- [x] Added user-facing doc: `support/docs/regime-classifier-sidecar-chain.md`.
...
- [x] RED:
  - `python3 -m unittest support/scripts/research/tests/test_regime_sidecar_pipeline.py -v` -> missing module.
- [x] Target GREEN:
  - `python3 -m unittest support/scripts/research/tests/test_regime_sidecar_pipeline.py -v` -> 3 OK.
- [x] Full research suite:
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 91 OK.
...
```bash
git add \
  support/docs/plans/2026-05-09-regime-classifier-r11-handoff-todo.md \
