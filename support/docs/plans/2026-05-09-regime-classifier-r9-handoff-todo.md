...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_high_confidence_decision.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_high_confidence_decision'`.
- [x] Implemented: `support/scripts/research/regime_high_confidence_decision.py`.
...
- [x] RED:
  - `python3 -m unittest support/scripts/research/tests/test_regime_high_confidence_decision.py -v` -> missing module.
- [x] Target GREEN:
  - `python3 -m unittest support/scripts/research/tests/test_regime_high_confidence_decision.py -v` -> 5 OK.
- [x] Full research suite:
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 84 OK.
...
```bash
python3 support/scripts/research/regime_high_confidence_decision.py \
...
```bash
git add \
  support/docs/plans/2026-05-09-regime-classifier-r9-handoff-todo.md \
