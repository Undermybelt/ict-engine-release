...
Evidence
- `support/docs/backend-path-audit.md`
- `support/docs/release-notes-draft.md`

What changed
- active `support/scripts/` path discovery now routes through `support/scripts/path_defaults.py`
...
Evidence
- `support/docs/audits/release-signoff.md`
- `support/docs/audits/pre-release-audit.md`
