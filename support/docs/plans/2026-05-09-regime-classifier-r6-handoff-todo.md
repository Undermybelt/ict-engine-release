...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_conformal_calibration_report.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_conformal_calibration_report'`.
- [x] Implemented: `support/scripts/research/regime_conformal_calibration_report.py`.
...
- [x] Target tests:
  - `python3 -m unittest support/scripts/research/tests/test_regime_conformal_calibration_report.py -v` -> 4 OK.
- [x] Full research suite after R6:
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 72 OK.
...
```bash
python3 support/scripts/research/regime_conformal_calibration_report.py \
...
- [x] `support/scripts/research/regime_distributional_agreement_report.py`
- [x] `support/scripts/research/tests/test_regime_distributional_agreement_report.py`
