...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_consumer_bundle.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_consumer_bundle'`.
- [x] Implemented: `support/scripts/research/regime_consumer_bundle.py`.
...
- [x] RED:
  - `python3 -m unittest support/scripts/research/tests/test_regime_consumer_bundle.py -v` -> missing module.
- [x] Target GREEN:
  - `python3 -m unittest support/scripts/research/tests/test_regime_consumer_bundle.py -v` -> 4 OK.
- [x] Full research suite:
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 88 OK.
...
```bash
python3 support/scripts/research/regime_consumer_bundle.py \
...
- [ ] `support/scripts/research/regime_sidecar_pipeline.py`
- [ ] `support/scripts/research/tests/test_regime_sidecar_pipeline.py`
- [ ] `support/docs/regime-classifier-sidecar-chain.md`
...
```bash
git add \
  support/docs/plans/2026-05-09-regime-classifier-r10-handoff-todo.md \
  support/scripts/research/regime_consumer_bundle.py \
  support/scripts/research/tests/test_regime_consumer_bundle.py
```
