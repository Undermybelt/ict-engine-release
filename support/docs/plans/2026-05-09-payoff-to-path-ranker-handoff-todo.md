...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_payoff_to_path_ranker_target.py`
- [x] Verified RED: missing `payoff_to_path_ranker_target` import
- [x] Implemented exporter script: `support/scripts/research/payoff_to_path_ranker_target.py`
...
- [x] Target tests passed:
  - `python3 -m unittest support/scripts/research/tests/test_payoff_to_path_ranker_target.py support/scripts/research/tests/test_heuristic_payoff_pipeline.py` -> 4 OK

### Next

- [x] Run full research tests
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 33 OK
...
```bash
python3 support/scripts/research/payoff_to_path_ranker_target.py \
