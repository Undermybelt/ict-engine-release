...
- 自动学习"语义"表示
- 容忍缺失和顺序变异
- embedding 可直接喂给 CatBoost voting layer
...
**产出**：
- `support/scripts/pda_dtw_poc.py`
- `support/docs/plans/pda-dtw-poc-results.md`
...
5. CatBoost voting layer 消费 embedding（额外特征）
...
| Autoencoder embedding | `PolicyFeatureVector` | CatBoost extra feature |
