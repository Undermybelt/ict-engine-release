...
> 来源 insight doc: `support/docs/the_well-physics-sim-ict-insights.md`
> 对齐主计划: `support/docs/plans/execution-operating-system-plan.md`
...
- 本 plan 所有公式直接来源: `support/docs/the_well-physics-sim-ict-insights.md` §1-4
- 约束与目标来源: `support/docs/plans/execution-operating-system-plan.md`
