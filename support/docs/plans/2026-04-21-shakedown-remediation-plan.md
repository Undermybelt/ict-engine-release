...
**Goal:** Close the highest-priority issues from `support/docs/audits/2026-04-21-full-codebase-shakedown.md` so contributor onboarding, human CLI usage, and agent consumption all behave consistently and predictably.
...
**Tech Stack:** Rust 2021, clap 4, serde_json, existing `main.rs` CLI dispatch, `application::reporting`, `application::orchestration`, repo docs under `support/docs/`, `cargo test`, `cargo fmt`
...
- Modify: `README.md`
- Modify: `support/docs/audits/2026-04-21-cross-surface-review.md`
...
- Modify: `support/docs/audits/2026-04-21-cross-surface-review.md`
- Modify: `README.md`
- Optionally create: `support/docs/CONTRIBUTOR_STATUS.md`
...
Run: `rg -n "clippy|CI|duration_sizing_scale|cargo test" README.md support/docs/`
