...
- [x] Failing tests written first: `support/scripts/research/tests/test_paper2code_adapters.py`
- [x] RED verified: missing `paper2code_adapters` import
- [x] Implemented `support/scripts/research/paper2code_adapters.py`
- [x] Adapter families:
...
- [x] Target tests passed:
  - `python3 -m unittest support/scripts/research/tests/test_paper2code_adapters.py -v` -> 3 OK

### Next

- [x] Run full research tests
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 52 OK
...
```bash
python3 support/scripts/research/paper2code_adapters.py \
