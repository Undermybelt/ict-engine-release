...
- [x] Failing tests written first: `support/scripts/research/tests/test_transition_evidence_aggregator.py`
- [x] RED verified: missing `transition_evidence_aggregator` import
- [x] Implemented `support/scripts/research/transition_evidence_aggregator.py`
- [x] CLI supports:
  - `--regime-report-json`
  - `--drift-jsonl`
  - `--output-json`
...
- [x] Run target tests
  - `python3 -m unittest support/scripts/research/tests/test_transition_evidence_aggregator.py` -> 3 OK
- [x] Run full research tests
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 42 OK
...
```bash
python3 support/scripts/research/transition_evidence_aggregator.py \
