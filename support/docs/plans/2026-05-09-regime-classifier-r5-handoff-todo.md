...
- [x] Wrote failing tests first: `support/scripts/research/tests/test_regime_expert_trainer.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_expert_trainer'`.
- [x] Implemented: `support/scripts/research/regime_expert_trainer.py`.
...
- [x] Target tests:
  - `python3 -m unittest support/scripts/research/tests/test_regime_expert_trainer.py -v` -> 4 OK.
...
- [x] `support/scripts/research/regime_conformal_calibration_report.py`
- [x] `support/scripts/research/tests/test_regime_conformal_calibration_report.py`
