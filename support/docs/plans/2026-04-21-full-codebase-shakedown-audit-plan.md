...
Produce a repo-local audit in `support/docs/` that reviews the whole `ict-engine` codebase from three perspectives:
...
1. Capture current repo state and existing support/docs/audits.
...
6. Save final audit in `support/docs/`.
