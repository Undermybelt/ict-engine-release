...
- update `support/docs/factor-catalog.md`
...
**Files:**
- Create: `support/docs/research/heuristic-learning-runtime-contract.md`
- Modify: `support/docs/factor-catalog.md`
...
5. Add a link from `support/docs/factor-catalog.md`.

**Verify:**
```bash
grep -n "Heuristic System" support/docs/research/heuristic-learning-runtime-contract.md
grep -n "heuristic-learning-runtime-contract" support/docs/factor-catalog.md
```
...
**Files:**
- Create: `support/scripts/research/heuristic_attempt_schema.py`
- Test: `support/scripts/research/tests/test_heuristic_attempt_schema.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_heuristic_attempt_schema.py -q
```
...
**Files:**
- Create: `support/scripts/research/heuristic_chain_verdict.py`
- Test: `support/scripts/research/tests/test_heuristic_chain_verdict.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_heuristic_chain_verdict.py -q
```
...
**Files:**
- Create: `support/scripts/research/regime_confidence_report.py`
- Test: `support/scripts/research/tests/test_regime_confidence_report.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_regime_confidence_report.py -q
```
...
**Files:**
- Create: `support/scripts/research/factor_payoff_shape_report.py`
- Test: `support/scripts/research/tests/test_factor_payoff_shape_report.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_factor_payoff_shape_report.py -q
```
...
**Files:**
- Modify: `support/scripts/research/bbn_structure_search.py`
- Test: `support/scripts/research/tests/test_bbn_structure_search.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_bbn_structure_search.py -q
```
...
**Files:**
- Create: `support/scripts/research/execution_tree_replay_pack.py`
- Test: `support/scripts/research/tests/test_execution_tree_replay_pack.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_execution_tree_replay_pack.py -q
```
...
**Files:**
- Create: `support/scripts/research/heuristic_retrospective.py`
- Test: `support/scripts/research/tests/test_heuristic_retrospective.py`
...
**Verify:**
```bash
python3 -m pytest support/scripts/research/tests/test_heuristic_retrospective.py -q
```
...
- Modify: `AGENTS.md`
- Modify: `support/docs/factor-catalog.md`
- Modify: `support/docs/plans/2026-05-05-execution-tree-factor-auto-quant-todo.md`
...
**Verify:**
```bash
grep -n "Heuristic Learning" AGENTS.md support/docs/factor-catalog.md support/docs/plans/2026-05-05-execution-tree-factor-auto-quant-todo.md
```
...
python3 support/scripts/research/heuristic_chain_verdict.py \
  --candidate-id demo-smoke \
  --state-dir /tmp/ict-hl-smoke \
  --output /tmp/ict-hl-smoke/NQ/candidates/demo-smoke/chain_verdict.json
python3 support/scripts/research/heuristic_retrospective.py \
  --state-dir /tmp/ict-hl-smoke \
