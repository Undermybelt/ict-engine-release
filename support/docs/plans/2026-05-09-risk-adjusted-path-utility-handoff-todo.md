...
- [x] Failing tests written first in `support/scripts/research/tests/test_payoff_to_path_ranker_target.py`
- [x] RED verified: missing utility fields and helper
- [x] Implemented utility columns in `support/scripts/research/payoff_to_path_ranker_target.py`
- [x] Target tests passed:
  - `python3 -m unittest support/scripts/research/tests/test_payoff_to_path_ranker_target.py -v` -> 3 OK

### Next

- [x] Run full research tests
  - `python3 -m unittest discover -s support/scripts/research/tests -p 'test_*.py'` -> 46 OK
