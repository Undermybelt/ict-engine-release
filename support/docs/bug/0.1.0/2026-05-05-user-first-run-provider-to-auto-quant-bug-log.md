...
- Safe fallback found: `README.md` and `support/docs/first-run.md` describe a safer entry path, but the CLI itself does not surface it.
...
- Safe fallback found: read `support/docs/2026-04-26-multi-exchange-data-source-integration-plan.md`.
...
- Command: `./target/debug/ict-engine backtest --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-backtest --human`
...
- Command: `./target/debug/ict-engine factor-research --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-aqresearch --human`
...
- Command: `./target/debug/ict-engine workflow-status --symbol DEMO --state-dir /tmp/ict-engine-user-first-run-20260505-150459-demo --human`; `./target/debug/ict-engine factor-research --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-demo --backend native --human`
