...
./target/debug/ict-engine backtest --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-backtest --human
./target/debug/ict-engine factor-backtest --help
./target/debug/ict-engine factor-backtest --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-factor-backtest --human
./target/debug/ict-engine factor-research --help
./target/debug/ict-engine factor-research --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-demo --backend native --human
./target/debug/ict-engine factor-research --symbol DEMO --data support/examples/demo/demo-15m.json --state-dir /tmp/ict-engine-user-first-run-20260505-150459-aqresearch --human
...
1. The repo docs are materially better than the CLI entry surface. `README.md`, `support/docs/first-run.md`, and the Auto-Quant/IBKR/exchange docs clearly describe the intended architecture and low-pollution expectations.
