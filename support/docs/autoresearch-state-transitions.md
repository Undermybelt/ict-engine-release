...
3. update `support/docs/autoresearch-derived-surfaces-contract.md` if trust boundaries change
4. update `support/docs/research-system-map.md` if read order or state-file meaning changes
