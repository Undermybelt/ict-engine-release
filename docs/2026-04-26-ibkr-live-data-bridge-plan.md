...
**Companion**: `docs/2026-04-26-multi-exchange-data-source-integration-plan.md`
...
1. `python scripts/ibkr_bridge/bridge.py ...`
2. `python scripts/auto_quant_external/fetch_external.py ibkr-historical ...`
...
**Verbatim text destined for `scripts/ibkr_bridge/README.md` top section**:
...
2. Run `python scripts/ibkr_bridge/setup.py --enable`. Verify:
...
3. Run `python scripts/ibkr_bridge/bridge.py --config example_config.yaml`
