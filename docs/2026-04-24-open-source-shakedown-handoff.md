...
This note is for the next human contributor or agent picking up the open-source shakedown work on `ict-engine`. It assumes you have read `README.md` and `docs/agent-first-runbook.md`.
...
- added the derived-surface contract (`docs/autoresearch-derived-surfaces-contract.md`) and state-transition notes (`docs/autoresearch-state-transitions.md`)
- captured the derived-surfaces review in `docs/audits/2026-04-23-autoresearch-derived-surfaces-review.md` and the external pattern intake under `docs/external/`

### Release metadata and contributor baseline drift (commit `16c6e54`)

- `Cargo.toml` `repository` now points at `https://github.com/Undermybelt/ict-engine-release`, which matches the actual release transport described in `docs/release-mirror-runbook.md`
- `README.md` contributor baseline now matches `.github/workflows/ci.yml` instead of calling clippy advisory
- recorded the versioned plan at `docs/plans/2026-04-23-open-source-shakedown-plan.md` and the follow-up audit at `docs/audits/2026-04-24-open-source-shakedown-follow-up.md`
...
- `docs/plans/2026-04-23-open-source-shakedown-plan.md`
- `docs/audits/2026-04-24-open-source-shakedown-follow-up.md`
