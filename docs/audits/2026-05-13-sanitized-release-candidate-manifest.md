...
- sanitized `examples/provider_profiles/thrill3r-nq-closed-loop-v1.json`
- sanitized `examples/factor_candidate_profiles/thrill3r-nq-auto-quant-v1.json`
...
- legacy local-data research scripts that still embed maintainer-local absolute
  paths
- historical docs/prompts that still contain maintainer-local absolute paths
...
- Final mirror hygiene pruned historical docs/prompts with concrete
