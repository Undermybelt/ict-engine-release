...
- repo docs review: `README.md`, `docs/first-run.md`, `docs/smoke-acceptance.md`, `docs/agent-first-runbook.md`, `docs/release-mirror-runbook.md`
- existing audits review, especially `docs/audit-2026-04-21-full-codebase-shakedown.md`
- worktree inspection via `git status --short`
- CLI/help audit via `python3 scripts/help_audit.py`
...
- `python3 scripts/help_audit.py` passes with no missing help descriptions
