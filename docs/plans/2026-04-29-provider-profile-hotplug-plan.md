...
- Store the personal profile as a versioned example JSON under `examples/provider_profiles/`.
...
- Create: `examples/provider_profiles/thrill3r-nq-closed-loop-v1.json`
