...
Run this forever in small batches. Commit only stable docs/tests/specs, never raw `/tmp` state.
...
13. Compress every 10-20 attempts: merge duplicates, prune dead params, update docs/factor-catalog.md.
...
python3 scripts/research/factor_payoff_shape_report.py --help
