...
**Scope:** scripts/research sidecar only unless a runtime integration defect is proven.
...
- [x] Added `scripts/research/heuristic_payoff_pipeline.py`
...
- [x] Run target test green
  - `python3 -m unittest scripts/research/tests/test_heuristic_payoff_pipeline.py` -> 2 OK
- [x] Run full `scripts/research/tests` regression
  - `python3 -m unittest discover -s scripts/research/tests -p 'test_*.py'` -> 30 OK
