...
**Tech Stack:** Rust CLI, existing Rust state persistence, additive Python helper scripts under `scripts/auto_quant_external/`
...
**Files:**
- Modify: `docs/bug/0.1.0/2026-04-28-nq-iteration-round-1.md`
...
```bash
git add docs/bug/0.1.0/2026-04-28-nq-iteration-round-1.md \
        docs/plans/2026-04-28-nq-iteration-blocker-remediation-plan.md \
