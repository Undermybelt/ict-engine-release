...
> Based on `docs/plans/2026-05-09-heuristic-learning-self-iteration-plan.md`.
...
Repo 已有基础：`paper2code/rammstein`、`paper2code/crowded_trades`、`paper2code/kyle_stochastic_liquidity`、`paper2code/red_queens_trap`。这些应先接入报告/门控层，不必重写。
...
```text
scripts/research/factor_payoff_shape_report.py
scripts/research/heuristic_chain_verdict.py
...
scripts/research/factor_candidate_pack.py
...
```text
scripts/research/factor_payoff_shape_report.py
scripts/research/policy_truth_reports.py
...
scripts/research/regime_confidence_report.py
...
```text
scripts/research/hmm_numeric_trainer.py        (exists)
scripts/research/regime_confidence_report.py   (new)
...
```text
scripts/research/bbn_structure_search.py       (exists)
src/bbn/evidence.rs
...
```text
scripts/auto_quant_external/pandas_path_ranker_trainer.py  (exists)
scripts/auto_quant_external/path_ranker_integration.py     (exists)
src/application/orchestration/execution_tree.rs
...
```text
scripts/auto_quant_external/vol_regime_v2_features.py       (exists)
scripts/auto_quant_external/vol_regime_cross_asset_features.py (exists)
scripts/research/regime_artifact_bundle.py
scripts/research/factor_payoff_shape_report.py
```
...
### paper2code/kyle_stochastic_liquidity
...
Integration:
```text
scripts/research/heuristic_retrospective.py
scripts/research/factor_payoff_shape_report.py
src/application/factor_lifecycle/expansion_evaluation.rs
```
...
scripts/research/portfolio_diversity_scorecard.py
scripts/research/heuristic_chain_verdict.py
scripts/research/heuristic_retrospective.py
```
...
```text
scripts/research/adapters/qlib_alpha158.py
scripts/research/adapters/worldquant_alpha101.py
scripts/research/adapters/ruptures_changepoint.py
scripts/research/adapters/mapie_conformal.py
scripts/research/adapters/hmmlearn_regime.py
scripts/research/adapters/statsmodels_markov_switching.py
scripts/research/adapters/river_drift.py
```
...
- keep external heavy deps in `scripts/research/` sidecar, not Rust runtime.
