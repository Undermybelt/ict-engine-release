...
> 上一轮 plan doc: `docs/plans/the-well-inspired-execution-optimizations.md`
> 主计划: `docs/plans/execution-operating-system-plan.md`
> 日期: 2026-04-21
...
**做什么**：
- 写一个 `scripts/round2_smoke_replay.sh` —
...
- `scripts/round2_smoke_replay.sh` 可跑可过
