...
- `scripts/regime_wasserstein_poc.py`
- Go/No-Go 判定
...
- `docs/plans/dna-sequence-inspired-pda-clustering-plan.md` — 原始 PDA 聚类 plan
- `docs/FRAME_FEATURES.md` — frame feature 定义
- `docs/FRAME_FEATURE_EXTENSION.md` — frame feature 扩展
- `src/hmm/` — 现有 HMM 模块
