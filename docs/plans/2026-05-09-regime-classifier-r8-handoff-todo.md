...
- [x] Wrote failing tests first: `scripts/research/tests/test_regime_transition_governor.py`.
- [x] RED verified: `ModuleNotFoundError: No module named 'regime_transition_governor'`.
- [x] Implemented: `scripts/research/regime_transition_governor.py`.
...
- [x] Target tests:
  - `python3 -m unittest scripts/research/tests/test_regime_transition_governor.py -v` -> 4 OK.
- [x] Full research suite after R8:
  - `python3 -m unittest discover -s scripts/research/tests -p 'test_*.py'` -> 79 OK.
