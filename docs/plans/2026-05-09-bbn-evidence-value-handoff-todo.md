...
- [x] Failing tests written first: `scripts/research/tests/test_bbn_evidence_value_report.py`
- [x] RED verified: missing `bbn_evidence_value_report` import
- [x] Implemented `scripts/research/bbn_evidence_value_report.py`
- [x] CLI supports:
  - `--rows-jsonl`
  - `--output-json`
  - `--candidate-id`
...
- [x] Run target tests
  - `python3 -m unittest scripts/research/tests/test_bbn_evidence_value_report.py -v` -> 3 OK
...
```bash
python3 scripts/research/bbn_evidence_value_report.py \
