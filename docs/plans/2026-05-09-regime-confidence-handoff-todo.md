...
- [x] Master TODO created: `docs/plans/2026-05-09-heuristic-learning-execution-todo.md`
- [x] Failing tests written first: `scripts/research/tests/test_regime_confidence_report.py`
- [x] RED verified: missing `regime_confidence_report` import
- [x] Implemented `scripts/research/regime_confidence_report.py`
- [x] CLI supports:
  - `--rows-jsonl`
  - `--output-json`
  - `--candidate-id`
...
- [x] Run target tests
  - `python3 -m unittest scripts/research/tests/test_regime_confidence_report.py` -> 3 OK
- [x] Run full research tests
  - `python3 -m unittest discover -s scripts/research/tests -p 'test_*.py'` -> 39 OK
...
```bash
python3 scripts/research/regime_confidence_report.py \
