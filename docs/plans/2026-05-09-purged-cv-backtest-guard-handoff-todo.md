...
- [x] Added failing tests first: `scripts/research/tests/test_purged_cv_backtest_guard.py`
- [x] Verified RED: missing `purged_cv_backtest_guard` import
- [x] Implemented `scripts/research/purged_cv_backtest_guard.py`
...
- [x] Run target tests
  - `python3 -m unittest scripts/research/tests/test_purged_cv_backtest_guard.py scripts/research/tests/test_heuristic_payoff_pipeline.py` -> 5 OK
- [x] Run full research tests
  - `python3 -m unittest discover -s scripts/research/tests -p 'test_*.py'` -> 36 OK
...
```bash
python3 scripts/research/purged_cv_backtest_guard.py \
