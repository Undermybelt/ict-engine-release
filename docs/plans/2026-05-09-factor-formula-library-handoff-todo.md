...
- [x] Failing tests written first: `scripts/research/tests/test_factor_formula_library.py`
- [x] RED verified: missing `factor_formula_library` import
- [x] Implemented `scripts/research/factor_formula_library.py`
...
- [x] Target tests passed:
  - `python3 -m unittest scripts/research/tests/test_factor_formula_library.py -v` -> 3 OK
...
```bash
python3 scripts/research/factor_formula_library.py \
