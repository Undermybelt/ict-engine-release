...
Files:
- Create: `docs/paper-driven-typed-packets-design.md`
- Modify: `docs/change-surface.md`
...
Step 2: Update `docs/change-surface.md`
Add a new section:
...
Run:
- `test -f docs/paper-driven-typed-packets-design.md && echo OK`
Expected: `OK`

Step 4: Commit
```bash
git add docs/paper-driven-typed-packets-design.md docs/change-surface.md
...
- Modify: `docs/paper-driven-typed-packets-design.md`
...
Step 4: Commit
```bash
git add src/factor_lab/factor_definition.rs docs/paper-driven-typed-packets-design.md
