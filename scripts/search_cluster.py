...
Examples:
  ...
  python3 scripts/search_cluster.py --target
  python3 scripts/search_cluster.py --backend-help
  python3 scripts/search_cluster.py --show-config
  python3 scripts/search_cluster.py --run --data-root /path/to/ict-cleaned-mtf
  python3 scripts/search_cluster.py --run
